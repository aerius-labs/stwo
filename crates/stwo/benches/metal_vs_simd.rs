    ...
    for log_size in [12, 15, 18, 21, 24] {
        ...
        group.bench_function(BenchmarkId::new("simd_fft", log_size), |b| {
            b.iter_batched(
                ...
                |(poly, twiddles)| {
                    SimdBackend::evaluate(&poly, domain, &twiddles)
                },
        ...
        group.bench_function(BenchmarkId::new("metal_fft", log_size), |b| {
            b.iter_batched(
                ...
                |(poly, twiddles)| {
                    MetalBackend::evaluate(&poly, domain, &twiddles)
                },
                BatchSize::LargeInput,
            )
        });
    ...
    for log_size in [12, 15, 18, 21, 24] {
        ...
        group.bench_function(BenchmarkId::new("simd_ifft", log_size), |b| {
            b.iter_batched(
                ...
                |(eval, twiddles)| {
                    SimdBackend::interpolate(eval, &twiddles)
                },
                BatchSize::LargeInput,
            )
        });
        ...
        group.bench_function(BenchmarkId::new("metal_ifft", log_size), |b| {
            b.iter_batched(
                ...
                |(eval, twiddles)| {
                    MetalBackend::interpolate(eval, &twiddles)
                },
                BatchSize::LargeInput,
            )
        });
